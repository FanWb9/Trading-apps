...
import { Wallet,CreditCard,Clock,PieChart,AlarmClock,Download,ClipboardList, Phone,CalendarDays,MessageCircle  } from "lucide-react";
export default function Pengeluaran(){
    ...
    const navLeft = [
        ...
        {
        title: t("Pengeluaran.navbar.section1.title"),
        desc: t("Pengeluaran.navbar.section1.desc"),
        image: Pengeluaran1,
        },
        {
        title: t("Pengeluaran.navbar.section2.title"),
        desc: t("Pengeluaran.navbar.section2.desc"),
        image: Biaya,
        },
    ...
    return(
        ...
        <div className="min-h-screen md:min-h-[60vh] lg:min-h-[100vh] bg-white text-gray-900 px-6 md:px-10 py-[90px] md:py-[40px] lg:py-[80px] flex flex-col-reverse md:flex-row items-center justify-between gap-10 ">
          ...
          <div className="w-full md:w-1/2 text-left">
            <h2 className="text-lg text-teal-500 font-semibold mb-2">{t("Pengeluaran.Items.title")}</h2>
            <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-4">
            {t("Pengeluaran.Items.desc")}
            </h1>
            <p className="text-base md:text-lg mb-8">
            {t("Pengeluaran.Items.desc1")}
            </p>
