...
import { Users,UserPlus,Settings,ShieldCheck,Clock,FileText,Phone,MessageCircle,CalendarDays} from "lucide-react";
export default function Akun(){
     const {t} = useTranslation();
        ...
        const navLeft = [
            ...
            {
            title: t("User.Navbar.section1.title"),
            desc: t("User.Navbar.section1.desc"),
            image: Akun1,
            },
            {
            title: t("User.Navbar.section2.title"),
            desc: t("User.Navbar.section2.desc"),
            image: Hak,
            },
        ...
        return(
            ...
            <div className="min-h-screen md:min-h-[60vh] lg:min-h-[100vh] bg-white text-gray-900 px-6 md:px-10 py-[90px] md:py-[40px] lg:py-[80px] flex flex-col-reverse md:flex-row items-center justify-between gap-10 ">
              ...
              <div className="w-full md:w-1/2 text-left">
                <h2 className="text-lg text-teal-500 font-semibold mb-2">{t("User.Items.title")}</h2>
          ...
          Kenapa Fitur Manajemen Pengguna Kami Penting?
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto mb-10">
          Kelola akun dan aktivitas pengguna secara terpusat untuk menjaga keamanan dan efisiensi operasional bisnis.
          </p>
