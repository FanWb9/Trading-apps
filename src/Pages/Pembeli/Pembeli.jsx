...
import pic1 from '../../assets/Pic Pembeli.png';
import { Users,ShoppingBag,Calendar,FileText,Link,AlarmClock,CreditCard,Truck,Phone,MessageCircle,CalendarDays} from "lucide-react";
export default function Pembeli(){
    ...
    const navLeft = [
        ...
        {
        title: t("Pembeli.Navbar.section1.title"),
        desc: t("Pembeli.Navbar.section1.desc"),
        image: Pembeli1,
        },
        {
        title: t("Pembeli.Navbar.section2.title"),
        desc: t("Pembeli.Navbar.section2.desc"),
        image: Penjual,
        },
    ...
    return(
        ...
        <div className="min-h-screen md:min-h-[60vh] lg:min-h-[100vh] bg-white text-gray-900 px-6 md:px-10 py-[90px] md:py-[40px] lg:py-[80px] flex flex-col-reverse md:flex-row items-center justify-between gap-10 ">
            ...
            <h2 className="text-lg text-teal-500 font-semibold mb-2">{t("Pembeli.Items.title")}</h2>
            <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-4">
            {t("Pembeli.Items.desc")}
            </h1>
            <p className="text-base md:text-lg mb-8">
            {t("Pembeli.Items.desc1")}
            </p>
       ...
       <section className="py-16 px-6 md:px-12 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          Kenapa Fitur Manajemen Pemasok Kami Penting?
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto mb-10">
          Kelola hubungan dengan pemasok secara profesional, efisien, dan terintegrasi dalam satu sistem.
          </p>
