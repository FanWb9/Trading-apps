     ...
     return (
       ...
       <section className="py-16 px-6 md:px-12 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          Kenapa Fitur Manajemen Produk Kami Membantu Bisnismu?
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto mb-10">
          Kelola seluruh data produk secara efisien, mulai dari stok, harga, hingga variasi — semua dalam satu sistem terpadu.
          </p>
