...
import pic1 from '../../assets/Pic Inven.png';
import { Boxes,History,Bell,Edit,ClipboardCheck,Truck,Archive, Package, PieChart, Phone,MessageCircle,CalendarDays } from 'lucide-react';
     ...
     const { t } = useTranslation();
         ...
         const featuresInventoryManagement = [
          ...
          const navLeft = [
             ...
             {
               title: t("Inventori.Navbar.section1.title"),
               desc: t("Inventori.Navbar.section1.desc"),
               image: Stok,
             },
         ...
         return (
            ...
            {showSuccess && (
             ...
             <div className="min-h-screen md:min-h-[60vh] lg:min-h-[100vh] bg-white text-gray-900 px-6 md:px-10 py-[90px] md:py-[40px] lg:py-[80px]  flex flex-col-reverse md:flex-row items-center justify-between gap-10 ">
               ...
               <div className="w-full md:w-1/2 text-center md:text-left">
                 <h2 className="text-lg text-teal-500 font-semibold mb-2">{t("Inventori.Items.title")}</h2>
                 <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-4">
                 {t("Inventori.Items.desc")}
                 </h1>
                 <p className="text-base md:text-lg mb-8">
                 {t("Inventori.Items.desc1")}
                 </p>
          ...
          <section className="py-16 px-6 md:px-12 bg-white">
            <div className="max-w-6xl mx-auto text-center">
              ...
              Kenapa Fitur Manajemen Inventaris Kami Penting?
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto mb-10">
              Pantau dan kelola stok barang dengan akurat dan real-time untuk memastikan operasional bisnis berjalan lancar.
              </p>
