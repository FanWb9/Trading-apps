...
import pic1 from '../../assets/Pic Gudang.png';
import {
  Boxes,
  ClipboardList,
  PackageCheck,
    ...
    return(
        ...
        <div className="min-h-screen md:min-h-[60vh] lg:min-h-[100vh] bg-white text-gray-900 px-6 md:px-10 py-[90px] md:py-[40px] lg:py-[80px] flex flex-col-reverse md:flex-row items-center justify-between gap-10 ">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            <h2 className="text-lg text-teal-500 font-semibold mb-2">{t("Gudang.Items.title")}</h2>
       ...
       <section className="py-16 px-6 md:px-12 bg-white">
          ...
          Kenapa Fitur Manajemen Gudang Kami Layak Digunakan?
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto mb-10">
          Kelola operasional gudang dengan lebih efisien dan akurat melalui sistem yang memantau pergerakan barang secara real-time.
          </p>
